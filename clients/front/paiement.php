...
<body>
	<div method="POST" class="form-box">
		...
		<form class="form-content">
            ...
            <div class="mb-3">
				<div class="form-field d-flex align-items-center"> 
					<span class="far fa-user"></span> 
					<input type="tel" name="tarif" id="tarif" placeholder="TARIF"> 
				</div>
			</div>

			<div style="margin-top: 30px; padding-bottom: 30px;">
				<button type="submit" class="btn btn-light">
					<a href="clientHome.html" style="color: black;">Retour</a>
				</button>
				
				<input type="submit" name='payer' class="btn btn-primary" style="margin-left: 180px" value="Commander">
			</div>
		</form>
	</div>
